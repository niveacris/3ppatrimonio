<?php
/**
 * Template da Página Inicial (Front Page) do Tema 3P Patrimônio
 * Prioridade máxima na hierarquia de templates do WordPress
 * Garante que a aplicação React 18 seja renderizada na Home Page
 *
